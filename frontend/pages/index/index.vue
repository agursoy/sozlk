    ...
    <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
      <div class="max-w-md mx-auto">
        <div class="divide-y divide-gray-200">
          ...
          >
            <p>
              Sozlk.com'a hoş geldiniz. İstediğiniz Osmanlıca kelimeyi
            ...
            <ul class="list-disc space-y-2">
              <li class="flex items-start">
                ...
                <p class="ml-2">
                  <code class="text-sm font-bold text-gray-900">50.000+</code
                  >'den fazla kelime veritabanı
                </p>
              </li>
              <li class="flex items-start">
                <span class="h-6 flex items-center sm:h-7">
                ...
                <p class="ml-2">
                  Kolay arayüz ile hızlı şekilde aramalarınız yapın
                </p>
              </li>
              <li class="flex items-start">
                <span class="h-6 flex items-center sm:h-7">
                ...
                <p class="ml-2">Birden fazla anlam ile arama özelliği</p>
              </li>
            </ul>
          </div>
          <div
          ...
          >
            <p>
              Soru ve şikayetlerinizi aşağıdaki adresten bizlere
              iletebilirsiniz.
            </p>
            <p>
              <a
